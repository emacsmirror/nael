...
;; characters that are common in Lean4 code.  For more information on
...
(define-abbrev-table 'nael-abbrev-table-only-singletons
  '(("\\\\" "\\" nil :system t)
    ...
    ("\\miny" "⧿" nil :system t)
    ("\\heq" "≍" nil :system t))
  "Abbrev table with singleton abbreviations for Lean4 code.
...
(define-abbrev-table 'nael-abbrev-table-only-skeletons
  ...
  "Abbrev table with Skeleton abbreviations for Lean4 code.
