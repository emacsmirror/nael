...
~nael~ is available on [[https://melpa.org/#/nael][Melpa]] (and [[https://stable.melpa.org/#/nael][Melpa-Stable]]) but ~nael-lsp~ not yet.  To install, first add the package-archive by adding this code to your Emacs initialization file and evaluating it interactively.
