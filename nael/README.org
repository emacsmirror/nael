...
- =\. SPC= correctly now expands to =· = with a space behind, all while the cursor is positioned at after the space character.
- Adjacent abbreviations expand correctly, i.e. =\.\. SPC= expands to two middle dots and a space.
- Two abbreviations have been dropped: "\" (backspace); and "+ " (plus and space).
